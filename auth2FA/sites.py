...
from auth2FA.views import AdminSetupTwoFactorAuthView, AdminConfirmTwoFactorAuthView
...
class AdminSite(admin.AdminSite):
    ...
    def login(self, request, *args, **kwargs):
        ...
        two_factor_auth_data = UserTwoFactorAuthData.objects.filter(user__username=username).first()
